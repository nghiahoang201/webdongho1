...
import styles from '../ProductFileNu/ProductFileNu.module.scss';
        ...
        <div className={cx('wrapper-productFileNu')}>
            <div className={cx('productFileNu-bannercategory')}>
                <img
                    ...
                    src={Images.imageProductFileNu}
                    alt="anh ProductFileNu"
                />
            </div>
            <div className={cd('grid', 'wide')}>
                <div className={cx('productFileNu-category')}>
                    <h4 className={cx('productFileNu-titleCategory')}>Đồng hồ nữ</h4>
                    <div className={cx('productFileNu-categoryboxsub')}>
                        <div className={cx('productFileNu-categoryDesc')}>
                            <p>Trang sức nói lên cá tính của người phụ nữ hiện đại</p>
                        </div>
                        ...
                        <div className={cx('productFileNu-category-collection')}>
                            <div className={cx('productFileNu-category-collection-boxLeft')}>
                                ...
                                <div className={cx('productFileNu-category-collection-leftConten')}>
                                    ...
                                    {menuSize ? <MenuProductSize menuSize={MENUSIZE_NU} /> : null}
                                </div>
                                <div className={cx('productFileNu-category-collection-leftConten')}>
                                    <button
                                        className={cx('productFileNu-category-collection-leftConten-btnMenu')}
                                    ...
                                    {menuColor ? <MenuProductColor menuColor={MENUCOLOR_NU} /> : null}
                                </div>
                                <div className={cx('productFileNu-category-collection-leftConten')}>
                                    <button
                                        className={cx('productFileNu-category-collection-leftConten-btnMenu')}
                                    ...
                                    {menuDaydh ? <MenuProductClday menuDayDh={MENUDAYDH_NU} /> : null}
                                </div>
                            </div>
                    ...
                    <div className={cx('productFileNu-category-completes')}>
                        <div className={cd('grid', 'wide')}>
                            <div className={cx('productFileNu-category-complete')}>
                                <div className={cx('productFileNu-category-complete-youtobe')}>
                                    <iframe
                                        width="570"
                                        height="360"
                                ...
                                <div className={cx('productFileNu-category-complete-context')}>
                                    <h3 className={cx('productFileNu-category-complete-context-title')}>MIX & MATCH</h3>
                                    <p className={cx('productFileNu-category-complete-context-subTitle')}>PHỤ KIỆN</p>
                                    <p className={cx('productFileNu-category-complete-context-conten')}>
                                        Khẳng định cá tính, phong cách của bản thân với những phụ kiện không thể thiếu
                                        từ Curnon
                                    </p>
                                    <div className={cx('productFileNu-category-complete-context-links')}>
                                        <a className={cx('productFileNu-category-complete-context-link')} href="/">
                                            KHÁM PHÁ NGAY
                                        </a>
                                    </div>
                                </div>
